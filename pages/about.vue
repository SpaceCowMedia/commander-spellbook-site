  ...
  <div class="container">
    ...
    <ul>
      ...
      <li>
        <a
          target="_blank"
          href="https://sheets.googleapis.com/v4/spreadsheets/1JJo8MzkpuhfvsaKVFVlOoNymscCt-Aw-1sob2IhpwXY/values:batchGet?ranges=combos!A2:R&key=AIzaSyDzQ0jCf3teHnUK17ubaLaV6rcWf9ZjG5E"
          >Combo Database GET API on Google Sheets</a
        >
      </li>
    </ul>
    ...
    >
    <br />-
    <a href="https://archidekt.com/user/17861" target="_blank">Goldshot20</a>
    <br />-
