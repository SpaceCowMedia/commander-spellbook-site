...
const SearchGuide: React.FC<Props> = ({
  heading,
  headingCardName,
  snippets,
  children,
  ...
  return (
    <div
      id={id}
      className={`${styles.searchGuide} ${styles.searchGuideContainer} border-b-2 border-gray-400 w-full`}
    >
      <div className="container mt-6 mb-6 pb-4">
        ...
        <div className="flex-none md:flex w-full">
          <div
            className={`${styles.description} w-full md:w-1/2 flex-grow pl-4 pr-4 md:pl-0`}
          >
            {children}
          </div>
