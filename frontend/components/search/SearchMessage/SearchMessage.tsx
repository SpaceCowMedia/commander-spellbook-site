...
const SearchMessage: React.FC<Props> = ({errors, message, currentPage, totalPages, totalResults, maxNumberOfCombosPerPage}: Props) => {
  ...
  return (
    <div>
      {errors && <div className={styles.searchErrors}>
        <div className="py-4 container">
          {errors}
        </div>
      </div>}
      {message && <div className={styles.searchDescription}>
        <div className="py-4 container">
          {fullMessage}
        </div>
      </div>}
