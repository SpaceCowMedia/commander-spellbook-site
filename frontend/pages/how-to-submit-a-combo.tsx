  ...
  return (
    <PageWrapper>
      ...
      <div className="static-page">
        ...
        <p>
          At this time, combo submissions (and updates) are only being accepted
          via
          <ExternalLink href="https://discord.gg/KDnvP5f">
            &nbsp;Discord
          </ExternalLink>
          , as we've learned from experience that many of them require a
          discussion. If your combo isn't listed here, or if you've found a bug
          with one of our combos, please join us on Discord to contribute to the
          catalog.
        </p>
