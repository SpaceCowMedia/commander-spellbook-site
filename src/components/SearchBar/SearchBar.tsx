import React, { FormEvent, useEffect, useRef, useState, ViewTransition } from 'react';
...
const SearchBar: React.FC<Props> = ({ onHomepage, className }) => {
  ...
  return (
    <ViewTransition name="site-search" share={SEARCH_DOCK} default="none">
        ...
        <form onSubmit={handleSubmit} className={styles.mainSearchInputContainer}>
          ...
          <div className="flex grow items-center">
            ...
            <input
              ...
              id="search-bar-input"
              type="text"
              className={`${styles.mainSearchInput} ${onHomepage ? `${styles.homepageInput} text-2xl text-center` : `${styles.navInput} pl-8 -ml-6`}`}
            />
          </div>
