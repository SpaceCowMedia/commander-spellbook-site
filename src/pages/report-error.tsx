    ...
    <>
      ...
      <div className={`static-page ${styles.reportErrorContainer}`}>
        ...
        <p>
          ...
          <ExternalLink href="https://discord.gg/commander-spellbook-673601282946236417">
            joining our Discord server
          </ExternalLink>
          . Once you have joined, copy and fill the following template to report an error in the&nbsp;
        ...
        <div className="text-center">
          <ExternalLink
            role="button"
            className="button"
            href="https://discord.com/channels/673601282946236417/673734250402545676"
          >
