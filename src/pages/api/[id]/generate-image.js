...
async function headerCanvas(identityArray) {
...
function cardsUsedCanvas(cards) {
  // Cards Used
...
function comboOutcomesCanvas(produces) {
  // Combo Outcomes
...
function drawImage(ctx, canvas, yPos) {
...
export default async function handler(req, res) {
  ...
  try {
    const combo = await variantsApi.variantsRetrieve({ id: req.query.id });
    if (!combo) {
